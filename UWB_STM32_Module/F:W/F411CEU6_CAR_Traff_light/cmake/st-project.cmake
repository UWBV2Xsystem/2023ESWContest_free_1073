...
# BASED ON /Users/chaedoyun/STM32CubeIDE/workspace_1.11.0/F_UWB_main
...
target_link_directories(
    ${TARGET_NAME} PRIVATE
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/Core/Inc>"
    "$<$<CONFIG:Debug>:/Users/chaedoyun/STM32CubeIDE/workspace_1.11.0/UWB_port>"
)
...
target_link_options(
    ...
    "$<$<CONFIG:Debug>:-Wl$<COMMA>--allow-multiple-definition>"
    "$<$<CONFIG:Debug>:-nolibc>"
    "$<$<CONFIG:Debug>:-Wl$<COMMA>--whole-archive>"
    "$<$<CONFIG:Debug>:-ldwt_uwb_driver-m4-hfp-6.0.7>"
    "$<$<CONFIG:Debug>:-Wl$<COMMA>--whole-archive>"
)
